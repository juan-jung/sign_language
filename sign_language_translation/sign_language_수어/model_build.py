...
from tensorflow.keras.layers import LSTM, GRU, RNN, SimpleRNN, Conv1D, MaxPool1D, Dropout, Flatten, Dense
...
#cnn // rnn때 주석처리
# model = Sequential()
# model.add(Conv1D(filters=32, kernel_size=5, strides=1, padding="causal", activation="relu", input_shape=(30, 1662)))
